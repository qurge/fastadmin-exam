define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'qurexam/category/index' + location.search,
                    add_url: 'qurexam/category/add',
                    edit_url: 'qurexam/category/edit',
                    del_url: 'qurexam/category/del',
                    multi_url: 'qurexam/category/multi',
                    import_url: 'qurexam/category/import',
